...
<head>
    <meta charset="UTF-8">
    <title>Inscription Moderateur</title>
    <style>
          body {
...
<body>
<h1>Inscrivez-vous en tant que Moderateur :</h1>
<form action="InscriptionModerateur" method="post"onsubmit="return doublemotdepasseegaux()">
